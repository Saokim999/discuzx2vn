...
function loadcalendar() {
	...
	s += '<th colspan="5" style="text-align: center"><a href="###" onclick="showdiv(\'year\');_cancelBubble(event)" title="Chọn năm" id="year"></a>&nbsp; - &nbsp;<a id="month" title="Chọn tháng" href="###" onclick="showdiv(\'month\');_cancelBubble(event)"></a></th>';
	s += '<th><A href="###" onclick="refreshcalendar(yy, mm+1)" title="Tháng sau">"</A></th>';
	s += '</tr>';
