...
drag.extend({
	...
	openStyleEdit : function (e) {
		...
		for (var k=0;k<31;k++) {
			...
			var stylearr = [{'key':'none','value':'none'},{'key':'Solid','value':'solid'},{'key':'dotted','value':'dotted'},{'key':'dashed','value':'dashed'}];
		var table = '<table class="tfm">';
			table += '<tr><th>Font</th><td><input class="px p_fre vm" id="fontsize" value="'+fontsize+'" size="2" /> px <input type="text" id="fontcolor" value="'+fontcolor+'" size="2" />';
			table += getColorPalette(id+'_fontPalette', 'fontcolor' ,fontcolor)+'</td></tr>';
			table += '<tr><th>Link</th><td><input class="px p_fre vm" id="linkfontsize" value="'+linkfontsize+'" size="2" />px <input type="text" id="linkcolor" value="'+linkcolor+'" size="2" />';
