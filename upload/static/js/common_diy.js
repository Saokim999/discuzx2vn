...
(function(){
		...
		setClose : function () {
			if (!this.isChange) {
				window.onbeforeunload = function() {
					return 'Dữ liệu được sửa đổi. Hủy bỏ sẽ không thể lưu những thay đổi';
				};
			}
			this.isChange = true;
		},
	...
	DIY.prototype = {
		...
		cancel : function () {
			var flag = false;
			if (this.isChange) {
				flag = confirm(this.cancelConfirm ? this.cancelConfirm : 'Thoát sẽ không lưu thiết lập. Xác nhận?');
			}
