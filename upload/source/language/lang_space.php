...
$lang = array(
	...
	'blockdata' => array('personalinfo' => 'Hồ sơ', 'profile' => 'Avatar', 'doing' => 'Status', 'feed' => 'Tin tức',
				...
				'block1'=>'Tùy chọn 1', 'block2'=>'Tùy chọn 2', 'block3'=>'Tùy chọn 3',
				'block4'=>'Tùy chọn 4','block5'=>'Tùy chọn 5'),
	...
	'wall_form' => '<div class="space_wall_post">
						<form action="home.php?mod=spacecp&ac=comment" id="quickcommentform_{uid}" name="quickcommentform_{uid}" method="post" autocomplete="off" onsubmit="ajaxpost(\'quickcommentform_{uid}\', \'return_commentwall_{uid}\');doane(event);">
							...
							'<div class="pt hm">Bạn cần phải đăng nhập trước <a href="member.php?mod=logging&action=login" onclick="showWindow(\'login\', this.href)" class="xi2">Đăng nhập</a> | <a href="member.php?mod='.$_G['setting']['regname'].'" class="xi2">'.$_G['setting']['reglinkname'].'</a></div>').'
