...
/**
 * Thiet lap cau hinh co so du lieu
 * @example
 * $_config['db']['1']['dbhost'] = 'localhost'; // Server Address
 * $_config['db']['1']['dbuser'] = 'root'; // Database user
 * $_config['db']['1']['dbpw'] = 'root';// Password
 * $_config['db']['1']['dbcharset'] = 'gbk';// Character Set
 * $_config['db']['1']['pconnect'] = '0';// Whether persistent connections
 * $_config['db']['1']['dbname'] = 'x1';// Database name
 * $_config['db']['1']['tablepre'] = 'pre_';// Table perfix
 *
