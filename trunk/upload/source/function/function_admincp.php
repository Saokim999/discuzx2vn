...
function rewritedata($alldata = 1) {
	...
	if(!$alldata) {
		...
		$data['rulesearch']['forum_forumdisplay'] = '{fid}-{page}/{tenbox}.html';
		...
		$data['rulesearch']['forum_viewthread'] = 'thread/{tenbai}-{tid}-{page}-{prevpage}.html';
		...
		$data['rulesearch']['home_blog'] = 'blog/{tenblog}-{uid}-{blogid}.html';
