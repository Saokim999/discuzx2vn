...
(
	'jack_name' => 'Đóng đinh',
	'jack_desc' => 'Dùng để kéo dài thời gian chú ý của chủ đề',
	'jack_expiration' => 'Thời gian',
	'jack_expiration_comment' => 'Chủ đề có thể ở TOP lâu dài, mặc định là 1 giờ',
	'jack_forum' => 'Cho phép sử dụng các đạo cụ của Diễn đàn',
	'jack_info' => '<p class="mtn xw0 mbn">Chủ đề còn có thể ở trên TOP <span class="xi1 xw1 xs2"> {expiration} </span> giờ</p> <p class="mtn xw0 mbn">Bây giờ bạn có <span class="xi1 xw1 xs2"> {magicnum}</span> có thể sử dụng</p>',
