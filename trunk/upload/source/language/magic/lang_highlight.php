...
(
	...
	'highlight_notification' => 'Chủ đề {subject} của bạn được 被 {actor} dùng {magicname},<a href="forum.php?mod=viewthread&tid={tid}">Xem nó!</a>',
	'highlight_notification_blogid' => 'Blog {subject} của bạn được 被 {actor} dùng {magicname},<a href="home.php?mod=space&do=blog&id={blogid}">Xem nó!</a>',
);
