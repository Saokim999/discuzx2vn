...
(
	...
	'post_edit' => '[i=s] bài này đã được sửa bởi {editor} lúc  {edittime} [/i]\n\n',
	'post_edit_regexp' => '/^\[i=s\] bài này  .*?  đã sửa lúc .*?  \[\/i\]\n\n/s',
	'post_edithtml' => '[i=s] bài đã được sửa bởi {editor} lúc {edittime}  [/i]<br /><br />',
	'post_edithtml_regexp' => '/^\[i=s\] bài này đã được sửa bởi .*? lúc .*?  \[\/i\]&lt;br \/&gt;&lt;br \/&gt;/s',
	'post_editnobbcode' => '[ bài viết được  {editor} sửa lúc {edittime} ]\n\n',
	'post_editnobbcode_regexp' => '/^\[ bài viết được  .*?  sửa lúc .*?  \]\n\n/s',
	'post_reply' => 'Trả lời',
	'post_thread' => 'Bài mới',
