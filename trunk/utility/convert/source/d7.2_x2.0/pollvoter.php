...
$nextpstep = $pstep + 1;
if($continue) {
	showmessage("Tiếp tục chuyển đổi các bảng dữ liệu ".$table_source."đã chuyển đổi $total bảng", "index.php?a=$action&source=$source&prg=$curprg&pstep=$nextpstep&total=$total");
}
?>